...
copyright = \markup {
 ...
 copyright = \markup {
  \line { 
    \small  { Licensed under the Creative Commons Attribution 4.0  License, for details see: \hspace #-0.5 \with-url #"http://creativecommons.org/licenses/by-sa/4.0" http://creativecommons.org/licenses/by-sa/4.0/ }
  }
 }
